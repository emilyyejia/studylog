...
urlpatterns = [
    ...
    path('problems/<int:problem_id>/remove-tag/<int:tag_id>/', views.remove_tag, name='remove-tag'),
    path('problems/<int:problem_id>/associate-tag/<int:tag_id>/', views.associate_tag, name='associate-tag'),
